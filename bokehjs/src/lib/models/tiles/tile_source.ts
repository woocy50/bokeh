...
export namespace TileSource {
  ...
  export type Props = Model.Props & {
    ...
    attribution: p.Property<string | DOMElement | null>
...
export abstract class TileSource extends Model {
  ...
  static {
    this.define<TileSource.Props>(({Number, String, Dict, Null, Nullable, Or, Ref}) => ({
      url:                [ String, "" ],
      tile_size:          [ Number, 256 ],
      max_zoom:           [ Number, 30 ],
      min_zoom:           [ Number, 0 ],
      extra_url_vars:     [ Dict(String), {} ],
      attribution:        [ Or(String, Ref(DOMElement), Null), null ],
